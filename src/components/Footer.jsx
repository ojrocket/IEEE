...
export default function Footer() {
   return (
      <footer className="bg-ieee-deep text-white pt-8 pb-4 px-8 md:px-16 border-t border-white/10 mt-auto z-10 relative">
         <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-8">
            ...
            <div className="flex gap-8 md:gap-16 font-sans text-sm">
               <div className="flex flex-col gap-2">
                  ...
                  <Link to="/executive-board" className="text-white/70 hover:text-white transition-colors">Executive Board</Link>
               </div>
               <div className="flex flex-col gap-2">
                  <span className="text-ieee-cyan font-bold tracking-widest uppercase text-xs mb-1">Connect</span>
                  <Link to="/join" className="text-white/70 hover:text-white transition-colors">Join IEEE</Link>
                  <a href="https://www.ieee.org/" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-white transition-colors">IEEE Global</a>
               </div>
            </div>
         </div>

         <div className="max-w-7xl mx-auto mt-8 pt-4 border-t border-white/10 flex flex-col md:flex-row justify-between opacity-50 text-xs font-sans">
